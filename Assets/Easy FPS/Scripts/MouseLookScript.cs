...
public class MouseLookScript : MonoBehaviour {
	...
	[SerializeField]
	private GameManager gameManager; // newly added
	...
	void Awake(){
        ...
        playerMovementScript = this.transform.GetComponent<PlayerMovementScript>();
	...
	*/
	void  Update(){
		...
		if(playerMovementScript.GetCurrentSpeed() > 1)
			HeadMovement ();
...
void FixedUpdate(){
    ...
    */
	...
	else if (playerMovementScript.GetMaxSpeed() > 5)
	{
